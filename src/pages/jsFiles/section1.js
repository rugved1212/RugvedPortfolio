    ...
    const interval = setInterval(() => {
      if (items.length > 0) {
        ...
        setItems((prevItems) => {
          ...
          const nextItem =
            initialItemsIndex >= initialItems.length
              ? initialItems[0]
    ...
    <div className="background">
      <div className="container1">
        ...
        <Typography className="abouttext">
          Passionate software developer with expertise in Java, Flutter, React,
          and Unity. Experienced in mobile app and game development, delivering
